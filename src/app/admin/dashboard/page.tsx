      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow rounded-lg p-6 border border-[#E5E5E5]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            {/* Employee Functions card for admins to access employee features */}
            <Link href="/employee/functions" className="bg-orange-50 border border-orange-100 rounded-lg p-6 text-center hover:bg-orange-400 hover:text-white transition-colors">

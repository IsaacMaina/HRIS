      ...
      <div className="fixed top-0 right-0 h-full w-64 bg-white/90 backdrop-blur-md z-50 shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto">
          ...
          <div className="flex items-center">
            {session?.user && (
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-80 backdrop-blur-md" align="end">
                  <DropdownMenuLabel>
                      ...
                      <DropdownMenuItem key={n.id} asChild>
                        <Link
                          ...
                          onClick={async (e) => {
                            ...
                            // Close the sidebar and navigate to notifications page
                            onClose();
        ...
        <nav className="p-4 space-y-2">
          ...
          {session?.user && (
            <Link
              href="/notifications"
              className={`block py-3 px-4 text-sm font-medium transition-colors flex justify-between items-center ${
